...
![](/images/post/mysql/database_patition_1.webp)
...
![](/images/post/mysql/modify_primary_key_by_navicat.webp "使用 Navicat 修改数据库表主键")
...
##### 使用 Navicat 进行分区
  ...
  ![](/images/post/mysql/create_partition_by_navicat_1.webp "Navicat 分区1")

  2. 添加分区( less than )

  ![](/images/post/mysql/create_partition_by_navicat_2.webp "Navicat 分区2")

  3. 添加最后一个分区( less than maxvalue)

  ![](/images/post/mysql/create_partition_by_navicat_3.webp "Navicat 分区3")
...
#### 查看分区文件
  ...
  ![](/images/post/mysql/partition_file.webp "分区文件")
