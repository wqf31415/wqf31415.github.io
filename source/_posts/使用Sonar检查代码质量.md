...
![](/images/post/server/sonarqube.webp)
...
![](/images/post/server/sonarqube_login.webp) 
...
![](/images/post/server/sonarqube_chinese_pack.webp)
...
![](/images/post/server/sonarqube_create_project.webp)
...
![](/images/post/server/sonarqube_analysis_maven.webp)
...
![](/images/post/server/sonarqube_do_analysis.webp)
...
![](/images/post/server/sonarqube_analysis_result.webp)

点击 **问题** 菜单，查看漏洞详情，能够按照多种方式进行过滤，这里我们选择查看 `严重` 级别的问题。

![](/images/post/server/sonarqube_analysis_issue.webp)
...
![](/images/post/server/sonarqube_analysis_modify.webp)
