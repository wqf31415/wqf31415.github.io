...
![](/images/post/excel/excel_bat_modify_filename_01.webp "原图") 

![](/images/post/excel/excel_bat_modify_filename_14.webp "效果图") 
...
![](/images/post/excel/excel_bat_modify_filename_02.webp ) 
...
![](/images/post/excel/excel_bat_modify_filename_03.webp) 

命令输入完成后，按回车运行命令，将会在文件夹中生成一个 `list.txt` 文件，里面就是需要的内容了；

![](/images/post/excel/excel_bat_modify_filename_04.webp) 
...
![](/images/post/excel/excel_bat_modify_filename_05.webp) 
...
![](/images/post/excel/excel_bat_modify_filename_09.webp) 
...
![](/images/post/excel/excel_bat_modify_filename_10.webp) 

此时，再看看文件名，发现已经修改成想要的格式；

![](/images/post/excel/excel_bat_modify_filename_11.webp)
...
![](/images/post/excel/excel_bat_modify_filename_12.webp) 

在此目录下打开命令行，执行指令 `ren.bat`，或直接双击这个 `.bat` 文件，即可运行，运行完成后，查看文件名，发现已经修改成功；

![](/images/post/excel/excel_bat_modify_filename_13.webp) 
