...
![](/images/post/hexo/logo_nodejs_hexo_github.webp "nodejs + hexo + github")
...
#### 安装nodejs
   ...
   - 在安装nodejs的同时会自动装上npm工具，在命令行输入 `npm -v` 查看npm版本，能显示出版本号说明安装成功，如下图。
      ![](/images/post/hexo/npm-v.webp "查看npm版本")
...
#### 安装git
   ...
   - 安装完成后运行打开命令行，运行 `git --version` 查看git版本，正常显示版本信息说明安装成功。
      ![](/images/post/hexo/git--version.webp "查看git版本")
...
#### 注册 GitHub 并创建博客仓库
  ...
  ![](/images/post/hexo/sign_up_for_github.webp "github注册") 

   ​

  - 注册完成后登录github，新建一个仓库取名叫 `username.github.io` ，username是刚才注册时填写的用户名

  ![](/images/post/hexo/github_create_repository_1.webp "点击右上角头像边的“+”号，点“New repository”") 
  ...
  ![](/images/post/hexo/github_create_repository_2.webp "填写仓库名username.github.io，点击“Create repository”")   
...
#### 注册coding 并创建博客仓库
  ...
  ![](/images/post/hexo/coding_index.webp "coding.net")


  - 中文网站注册过程就不再赘述了，注册完成后登录 coding，新建一个项目以用户名来命名，我的用户名叫wqf31415，因此我的项目名也叫wqf31415，选择“公开”选项，创建一个开源项目。

  ![](/images/post/hexo/coding_create_project.webp "在主界面点击“+"号新建项目，以用户名命名")
...
![](/images/post/hexo/aliyun.webp "注册并登录阿里云，点击域名注册") 


  ![](/images/post/hexo/aliyun_domain_search_1.webp "搜索自己想要的域名")
...
#### 在本地生成hexo博客
   ...
   - 初始化博客，新建一个文件夹，名为blog，用来存放所有文件，进入blog文件夹，在空白区域按住shift键右击，“在此处打开命令窗口”，执行下面命令，来生成博客需要的基本文件
     ...
     ![](/images/post/hexo/hexo_init_command.webp "初始化过程可能要等几分钟")

     ![](/images/post/hexo/hexo_init_files.webp "hexo init执行后生成的文件") 
   ...
   - 开启本地hexo服务来测试
     ...
     ![](/images/post/hexo/hexo_server_success.webp "已经在http://localhost:4000/ 开启hexo，按Ctrl + C停止服务") 

     现在可以打开本地浏览器，输入http://localhost:4000/ 来访问，如果出现下面的页面，就说明是真的成功了！！！

     ![](/images/post/hexo/hexo_firstPage.webp "hexo生成的最初页面") 
...
#### 上传blog到git仓库
   ...
   ![](/images/post/hexo/hexo_blog_config_deploy.webp "git配置仓库信息") 
   ...
   ![](/images/post/hexo/coding_open_pages.webp "点击“Pages 服务”") 
...
#### 绑定域名
   ...
   ![](/images/post/hexo/aliyun_domain_resolve.webp "解析域名") 

   - 添加解析记录，添加 **CNAME** 记录，主机记录为www，解析地址为username.github.io 或 username.coding.me 

   ![](/images/post/hexo/domain_resolve_record.webp "其中www记录解析到wqf31415.coding.me，blog记录解析到github仓库ip地址，实际就是wqf31415.github.io") 
   ...
   ![](/images/post/hexo/github_pages_CNAME.webp "手动添加一个CNAME文件，并填入域名") 
    
   - 解析到coding平台pages，登陆coding，打开部署博客的仓库，在自定义域名中添加自己的域名，我将www的记录解析到coding的Pages服务地址

   ![](/images/post/hexo/coding_pages_binding_domain.webp "将www.wqf31415.xyz解析到coding的Pages") 
