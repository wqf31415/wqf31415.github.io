...
![](http://blog-images.qiniu.wqf31415.xyz/image/logo_nodejs_hexo_github.png "nodejs + hexo + github")
...
#### 安装nodejs
   ...
   - 在安装nodejs的同时会自动装上npm工具，在命令行输入 `npm -v` 查看npm版本，能显示出版本号说明安装成功，如下图。
      ![](http://blog-images.qiniu.wqf31415.xyz/image/npm-v.png "查看npm版本")
...
#### 安装git
   ...
   - 安装完成后运行打开命令行，运行 `git --version` 查看git版本，正常显示版本信息说明安装成功。
      ![](http://blog-images.qiniu.wqf31415.xyz/image/git--version.png "查看git版本")
...
#### 注册 GitHub 并创建博客仓库
  ...
  ![](http://blog-images.qiniu.wqf31415.xyz/image/sign_up_for_github.png "github注册") 

   ​

  - 注册完成后登录github，新建一个仓库取名叫 `username.github.io` ，username是刚才注册时填写的用户名

  ![](http://blog-images.qiniu.wqf31415.xyz/image/github_create_repository_1.png "点击右上角头像边的“+”号，点“New repository”") 
  ...
  ![](http://blog-images.qiniu.wqf31415.xyz/image/github_create_repository_2.png "填写仓库名username.github.io，点击“Create repository”")   
...
#### 注册coding 并创建博客仓库
  ...
  ![](http://blog-images.qiniu.wqf31415.xyz/image/coding_index.png "coding.net")
...
![](http://blog-images.qiniu.wqf31415.xyz/image/aliyun.png "注册并登录阿里云，点击域名注册") 


  ![](http://blog-images.qiniu.wqf31415.xyz/image/aliyun_domain_search_1.png "搜索自己想要的域名")
...
#### 在本地生成hexo博客
   ...
   - 初始化博客，新建一个文件夹，名为blog，用来存放所有文件，进入blog文件夹，在空白区域按住shift键右击，“在此处打开命令窗口”，执行下面命令，来生成博客需要的基本文件
     ...
     ![](http://blog-images.qiniu.wqf31415.xyz/image/hexo_init_command.png "初始化过程可能要等几分钟")

     ![](http://blog-images.qiniu.wqf31415.xyz/image/hexo_init_files.png "hexo init执行后生成的文件") 
   ...
   - 开启本地hexo服务来测试
     ...
     ![](http://blog-images.qiniu.wqf31415.xyz/image/hexo_server_success.png "已经在http://localhost:4000/ 开启hexo，按Ctrl + C停止服务") 

     现在可以打开本地浏览器，输入http://localhost:4000/ 来访问，如果出现下面的页面，就说明是真的成功了！！！

     ![](http://blog-images.qiniu.wqf31415.xyz/image/hexo_firstPage.png "hexo生成的最初页面") 
...
#### 上传blog到git仓库
   ...
   ![](http://blog-images.qiniu.wqf31415.xyz/image/hexo_blog_config_deploy.png "git配置仓库信息") 
   ...
   ![](http://blog-images.qiniu.wqf31415.xyz/image/coding_open_pages.png "点击“Pages 服务”") 
...
#### 绑定域名
   ...
   ![](http://blog-images.qiniu.wqf31415.xyz/image/aliyun_domain_resolve.png "解析域名") 

   - 添加解析记录，添加 **CNAME** 记录，主机记录为www，解析地址为username.github.io 或 username.coding.me 

   ![](http://blog-images.qiniu.wqf31415.xyz/image/domain_resolve_record.png "其中www记录解析到wqf31415.coding.me，blog记录解析到github仓库ip地址，实际就是wqf31415.github.io") 
   ...
   ![](http://blog-images.qiniu.wqf31415.xyz/image/github_pages_CNAME.png "手动添加一个CNAME文件，并填入域名") 
    
   - 解析到coding平台pages，登陆coding，打开部署博客的仓库，在自定义域名中添加自己的域名，我将www的记录解析到coding的Pages服务地址

   ![](http://blog-images.qiniu.wqf31415.xyz/image/coding_pages_binding_domain.png "将www.wqf31415.xyz解析到coding的Pages") 
