...
#### 安装nodejs
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/npm-v.png "查看npm版本")
...
#### 安装git
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/git--version.png "查看git版本")
...
#### 在本地生成hexo博客
   ...
   - 初始化博客，新建一个文件夹，名为blog，用来存放所有文件，进入blog文件夹，在空白区域按住shift键右击，“在此处打开命令窗口”，执行下面命令，来生成博客需要的基本文件
     ...
     ![](http://okbn8yrzu.bkt.clouddn.com/image/hexo_init_command.png "初始化过程可能要等几分钟")
...
#### 上传blog到git仓库
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/hexo_blog_config_deploy.png "git配置仓库信息") 
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/coding_open_pages.png "点击“Pages 服务”") 
...
#### 绑定域名
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/aliyun_domain_resolve.png "解析域名") 
   
   - 添加解析记录，添加 **CNAME** 记录，主机记录为www，解析地址为username.github.io 或 username.coding.me 
   
   ![](http://okbn8yrzu.bkt.clouddn.com/image/domain_resolve_record.png "其中www记录解析到wqf31415.coding.me，blog记录解析到github仓库ip地址，实际就是wqf31415.github.io") 
   ...
   ![](http://okbn8yrzu.bkt.clouddn.com/image/github_pages_CNAME.png "手动添加一个CNAME文件，并填入域名") 
    
   - 解析到coding平台pages，登陆coding，打开部署博客的仓库，在自定义域名中添加自己的域名，我将www的记录解析到coding的Pages服务地址
    
   ![](http://okbn8yrzu.bkt.clouddn.com/image/coding_pages_binding_domain.png "将www.wqf31415.xyz解析到coding的Pages") 
