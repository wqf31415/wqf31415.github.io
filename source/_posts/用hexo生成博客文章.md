...
hexo new "Hello Hexo"
  ...
  ![](/images/post/hexo/hexo_new_article.webp "用Hexo生成一篇叫 Hello Hexo 的文章") 
...
执行完这条命令后，我们到 `source/_posts` 目录下看看，就会发现一个名叫 **Hello-Hexo.md** 的文件，.md文件是markdown格式文件的扩展名，实质上也是文本文件，我们可以用熟悉的文本编辑器来编写，最简单的就是直接用记事本打开，只要熟悉markdown语法就可以愉快的进行写作了。
  ...
  ![](/images/post/hexo/hexo_new_article_file.webp "Hexo生成的文章为 .md 格式") 
...
> 执行 `hexo generate` 命令后，hexo 将会解析 `/source/_post` 目录下的所有 markdown 文档，根据 hexo 主题配置渲染生成静态 html 页面文件。
  ...
  ![](/images/post/hexo/hexo_generate_article.webp "已经生成了文章的静态html页面") 
...
### 修改文章模板
  ...
  ![](/images/post/hexo/hexo_new_article_head.webp "用Hexo默认文章模板生成的文章") 
  ...
  ![](/images/post/hexo/hexo_scaffolds_post.webp "在post模板中增加了更新时间和分类属性") 
...
### 下台鞠躬！
  ...
  ![](/images/post/meme/meme_bow_01.webp) 