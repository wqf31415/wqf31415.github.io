...
把公司部门信息和员工信息写入表格中，需要包含用户名、姓、名、邮箱、性别、部门、岗位、电话，如下表：

| 用户名  | 姓   | 名   | 邮箱            | 性别 | 部门           | 岗位       | 电话        |
| ------- | ---- | ---- | --------------- | ---- | -------------- | ---------- | ----------- |
| zhaoyi  | 赵   | 一   | zhaoyi@abc.com  | 男   | /研发部        | 研发部经理 | 13100000000 |
| qianer  | 钱   | 二   | qianer@abc.com  | 女   | /研发部/后端组 | 后端组主管 | 13200000000 |
| sunsan  | 孙   | 三   | sunsan@abc.com  | 男   | /研发部/后端组 | 后端开发   | 13300000000 |
| lisi    | 李   | 四   | lisi@abc.com    | 男   | /研发部/后端组 | 后端开发   | 1340000000  |
| zhouwu  | 周   | 五   | zhouwu@abc.com  | 女   | /研发部/前端组 | 前端组主管 | 13500000000 |
| wuliu   | 吴   | 六   | wuliu@abc.com   | 女   | /研发部/前端组 | 前端开发   | 13600000000 |
| zhengqi | 郑   | 七   | zhengqi@abc.com | 男   | /研发部/前端组 | UI设计     | 13700000000 |
| wangba  | 王   | 八   | wangba@abc.com  | 男   | /财务部        | 财务主管   | 13800000000 |

根据员工表生成部门数据 json 和用户信息 json，可以放到一个 json 文件中一次导入，完整 json 文件格式如下：
...
完整示例文件: [](/example/realm-config.json) 
