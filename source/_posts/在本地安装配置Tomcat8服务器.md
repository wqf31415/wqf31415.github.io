...
![](/images/post/windows/tomcat.webp) 
...
![](/images/post/windows/download_tomcat_for_windows.webp "根据系统选择32/64位")
...
![](/images/post/windows/open_system_config_on_windows.webp "打开‘高级系统设置’")

在 **“系统属性”** 对话框中选择 **“高级”** 选项卡，点击下方的 **“环境变量”**
![](/images/post/windows/open_environment_variable.webp "打开‘环境变量’")

在 **“环境变量”** 中的 **“系统变量”** 中点击 **“新建”**，在 **“新建系统变量”** 中的 **“变量名”** 输入框中输入 **CATALINA_HOME** ，在 **“变量值”** 输入刚才的 tomcat 安装路径 **E:\tomcat\apache-tomcat-8.5.14** 
![](/images/post/windows/add_new_environment_variable_CATALINA_HOME.webp "添加 CATALINA_HOME") 
...
![](/images/post/windows/tomcat_directory.webp "tomcat 目录") 
...
![](/images/post/windows/startup_tomcat.webp "运行 startup.bat")

打开 [http://localhost:8080/](http://localhost:8080/ ) 若能打开页面，说明 tomcat 服务器已成功启动。
![](/images/post/windows/tomcat_index.webp "http://localhost:8080/") 
