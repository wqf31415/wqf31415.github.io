...
![](/images/post/spring/spring-boot-banner.txt.webp "banner.txt 文件位置")
...
![](/images/post/spring/banner.gif "banner.gif")
...
![](/images/post/spring/text2text-graph.webp "生成文字图")
...
![](/images/post/spring/img2txt-1.webp "在线图片转文字")

=======>

![](/images/post/spring/img2txt-2.webp "文字图")

将文字部分粘贴到 `banner.txt` 中，运行项目看到：

![](/images/post/spring/img2txt-3.webp "初始效果")
...
![](/images/post/spring/img2txt-4.webp "使用 Word 给每个字符间添加空格")



最终效果：

![](/images/post/spring/img2txt-5.webp "最终效果图")
