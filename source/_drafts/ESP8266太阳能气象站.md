...
![](/images/post/esp8266/esp8266_weather_station.webp) 
...
![mt3608](/images/post/esp8266/mt3608.webp) 



本项目使用带充放电保护的 TP4056 锂电池充电模块，太阳能板提供的 3.5V电压经过 MT3608 升压到 5V，再输入到 TP4056 为电池充电。

![tp4056](/images/post/esp8266/tp4056.webp) 
...
![](/images/post/esp8266/hw106.webp) 



#### 读取温湿度数据

项目中使用 DHT11 温湿度模块采集数据，在Arduino 开发工具的库管理器中添加`DHT11` 库即可获取到相关示例。
...
![tp4056](/images/post/esp8266/weather_station_server_log.webp) 
